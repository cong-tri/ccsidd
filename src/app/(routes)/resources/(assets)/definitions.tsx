...
export const definitions = {
  ...
  info: [
    {
      title: "International Direct Dial",
      description:
        "IDD refers to a service offers by operators to make International Calls using a defined prefix.",
    },
    {
      title: "Service Based Operator",
      description: (
        <>
          When the telecommunication market liberalized in the year 2001, The
          ...
          INDIVIDUAL licenses. A full description on each licenses can be
          obtained via{" "}
          <a href='http://www.ida.gov.sg' target='_blank'>
            Infocomm Development Authority (IDA)
          </a>
          .As its name apply, licensee will be able to provide telecommunication
          services, with no oblgation to building infrastructures as required by
          Fixed Based Operator (FBO).
        </>
      ),
    },
    {
      title: "Fixed Based Operator",
      description: (
        <>
    ...
    {
      title: "Public Switch Telecommunication Network (PSTN)",
      description:
    ...
    {
      title: "Tandem Based Network (TDM)",
      description:
